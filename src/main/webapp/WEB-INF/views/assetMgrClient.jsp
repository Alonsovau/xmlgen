...
$(document).ready(function(){
	  ...
	  var data = { seqno: $('#seqno').val(), 
	  			   ...
	  			   xmlnum: $('#xmlnum').val() };
	  $.post("/assetMgrClient/preview", data,function(data) {
...
<body>
	<div style="width: 1400px;">
		<a href="/">首页</a> <a href="/naturalPerson">自然人</a> <a
			href="/generalCorporate">一般法人</a> <a href="/specialCorporate">特殊法人</a>
...
.text1 {
	...
	height: 30px
		...
		<form target="down-iframe" method="post"
			action="${ctx}/naturalPerson/download">
			<fieldset>
				<table border="1" cellspacing="0" cellpadding="0"
					...
					<tr>
						...
						<td>业务流水号：</td>
						<td><input type="text" id="processid" name="processid"
							class="text1" placeholder="输入格式0001-W-yymmdd-XXXXXXX" /></td>
					</tr>
					<tr>
						<td>业务类型：</td>
						<td><input type="text" id="processtype" name="processtype"
							class="text1" readonly="readonly" value="1" /></td>
						<td>流程日期：</td>
						<td><input type="text" id="processdate" name="processdate"
							class="text1" placeholder="输入格式yyyy-mm-dd" /></td>
					</tr>
					<tr>
						<td>客户类型：</td>
						<td><input type="text" id="clienttype" name="clienttype"
							readonly="readonly" class="text1" value="5" /></td>
						<td>资管客户类型：</td>
						<td><select name="assetmgr_clienttype"
							id="assetmgr_clienttype" style="width: 400px; height: 30px"
							onchange="check(this)">
								<option value="1">1（个人资管）</option>
								<option value="2">2（一般单位资管）</option>
								<option value="4">4（特殊单位资管）</option>
								<option value="5">5（一对多资管）</option>
						</select></td>
					</tr>
					<tr>
						<td>客户名称：</td>
						...
						<td>分户管理资产名称：</td>
						<td><input type="text" id="ledger_manage_name" name="ledger_manage_name" class="text1" /></td>
					</tr>
					<tr>
						<td>客户地域：</td>
							<td><input type="text" id="clientregion" name="clientregion" class="text1" value="1" /></td>
						<td>国家或地区：</td>
							<td><input type="text" id="nationality" name="nationality" class="text1" value="CHN" /></td>				
					<tr>
						<td>证件类型：</td>
					...
					<tr>
						...
						<td>营业部代码：</td>
						<td><input type="text" id="option_id" name="option_id"
							class="text1" /></td>
					</tr>
					<tr>
						<td>交易类型：</td>
						<td><select name="exclientidtype" id="exclientidtype"
							style="width: 400px; height: 30px" onchange="check(this)">
						...
						<td>开户数：</td>
						<td><input type="text" id="clientnum" name="clientnum"
							class="text1" /></td>
					</tr>
					<tr>
						<td>投资者类型：</td>
						<td><input type="text" id="classify" name="classify"
							class="text1" readonly="readonly" value="01" /></td>
						<td>xml数：</td>
						<td><input type="text" id="xmlnum" name="xmlnum"
							class="text1" /></td>
					</tr>
				</table>
			</fieldset>
				...
				<tr>
					<td>
						<button id="b01" type="button"
							style="width: 100px; height: 30px; float: right">预览</button>
					</td>
					<td><button type="submit" value="下载"
							style="width: 100px; height: 30px">下载</td>
				</tr>
			</table>
		</form>
